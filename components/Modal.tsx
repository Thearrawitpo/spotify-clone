      ...
      <Dialog.Portal>
        ...
        >
          <Dialog.Content
            ...
            top-[50%] left-[50%] max-h-full h-full md:h-auto w-full md:w-[90vw]
            translate-x-[-50%] translate-y-[-50%] rounded-md bg-neutral-800 p-[25px]
            focus:outline-none md:max-w-[450px] md:max-h-[85vh]'
          >
            ...
            <Dialog.Close asChild>
              <button
                className='text-neutral-400 hover:text-white absolute top-[10px]
